...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE IF NOT EXISTS "search_locales" (
  	...
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL,
  	CONSTRAINT "search_locales_locale_parent_id_unique" UNIQUE("_locale","_parent_id")
  );
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "footer" ADD COLUMN "org_name" varchar DEFAULT 'Urgent Action Fund Asia Pacific' NOT NULL;
  ...
  ALTER TABLE "public"."header_languages" ALTER COLUMN "value" SET DATA TYPE text;
  DROP TYPE "public"."enum_header_languages";
  CREATE TYPE "public"."enum_header_languages" AS ENUM('en', 'th', 'hn', 'in', 'np', 'kh');
  ALTER TABLE "public"."header_languages" ALTER COLUMN "value" SET DATA TYPE "public"."enum_header_languages" USING "value"::"public"."enum_header_languages";
