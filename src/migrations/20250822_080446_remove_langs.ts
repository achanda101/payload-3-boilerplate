...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "contact_info_emails_locales" ALTER COLUMN "label" SET DEFAULT 'Contact Us';
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "contact_info_emails_locales" ALTER COLUMN "label" DROP DEFAULT;`)
}
