...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "posts_locales" DROP CONSTRAINT IF EXISTS "posts_locales_meta_image_id_media_id_fk";
  
  ALTER TABLE "_posts_v_locales" DROP CONSTRAINT IF EXISTS "_posts_v_locales_version_meta_image_id_media_id_fk";
  
  ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "users_avatar_id_media_id_fk";
  
  ALTER TABLE "search" DROP CONSTRAINT IF EXISTS "search_meta_image_id_media_id_fk";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "posts_locales" DROP CONSTRAINT IF EXISTS "posts_locales_meta_image_id_media_cloud_id_fk";
  
  ALTER TABLE "_posts_v_locales" DROP CONSTRAINT IF EXISTS "_posts_v_locales_version_meta_image_id_media_cloud_id_fk";
  
  ALTER TABLE "users" DROP CONSTRAINT IF EXISTS "users_avatar_id_media_cloud_id_fk";
  
  ALTER TABLE "search" DROP CONSTRAINT IF EXISTS "search_meta_image_id_media_cloud_id_fk";
  
  ALTER TABLE "header" DROP CONSTRAINT IF EXISTS "header_logo_id_media_cloud_id_fk";
