...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "grants_blocks_mcol_info_block_multicols" (
  	...
  	"link_url" varchar,
  	"link_appearance" "enum_grants_blocks_mcol_info_block_multicols_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE "_grants_v_blocks_mcol_info_block_multicols" (
  	...
  	"link_download_link" boolean,
  	"link_url" varchar,
  	"link_appearance" "enum__grants_v_blocks_mcol_info_block_multicols_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
