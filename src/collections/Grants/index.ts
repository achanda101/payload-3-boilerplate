...
export const Grants: CollectionConfig<'grants'> = {
  ...
  admin: {
    ...
    defaultColumns: ['heroTitle', 'pageType', 'bgType', '_status', 'folder'],
    livePreview: {
      url: ({ data, locale }) => {
  ...
  fields: [
    ...
    ...slugField(),
    // Manual SEO fields (Grants removed from seoPlugin as they don't have a cover image for auto-generation)
    {
      name: 'meta',
      type: 'group',
      label: 'SEO',
